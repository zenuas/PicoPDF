...
public class SectionBinder4CrossSectionFillRectangleTest
{
    ...
    public static string ToSectionString(SectionModel section) => $"{section.Section.Name},top={section.Top}/{section.Elements.OfType<ITextModel>().Select(x => x.Text).Join("/")}|{section.Elements.OfType<MutableFillRectangleModel>().Select(x => $"x1={x.X},y1={section.Top + x.Y},x2={x.X + x.Width},y2={section.Top + x.Y + x.Height}").Join("/")}";
    ...
    public static PageSection PageSection { get; } = JsonLoader.LoadJsonString("""
{
	...
	"Sections": [
		...
		{"Type": "HeaderSection", "Name": "Header2", "Height": 10, "Elements": [
			...
			{"Type": "BindElement", "Bind": "Key2",  "Size": 10, "X": 20, "Y": 0},
			{"Type": "BindElement", "Bind": "Key3",  "Size": 10, "X": 30, "Y": 0},
			{"Type": "CrossSectionFillRectangleElement", "X": 50, "Y": 5, "Width": 100, "Height": 10, "LineColor": "Black", "FillColor": "Red"},
		]},
