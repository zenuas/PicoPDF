...
public class SectionBinderTest
{
    ...
    public void GetSectionInfo_Depth1()
    {
        ...
        ISubSection subsection = new Section()
        {
            ...
            Footer = new FooterSection() { Name = "footer1", Height = 100, IsPageBreak = false, IsFill = false },
            SubSection = detail,
            BreakKey = "break",
        };
        var sections = SectionBinder.GetSectionInfo(subsection, pageheader);
    ...
    public void GetSectionInfo_Depth2()
    {
        ...
        ISubSection subsection = new Section()
        {
            ...
            SubSection = new Section()
            {
                ...
                Footer = new FooterSection() { Name = "footer2", Height = 100, IsPageBreak = false, IsFill = false },
                SubSection = detail,
                BreakKey = "break2",
            },
            BreakKey = "break1",
        ...
        ISubSection subsection = new Section()
        {
            ...
            SubSection = new Section()
            {
                ...
                SubSection = new Section()
                {
                    ...
                    Footer = new FooterSection() { Name = "footer3", Height = 100, IsPageBreak = false, IsFill = false },
                    SubSection = detail,
                    BreakKey = "break3",
                },
                BreakKey = "break2",
