...
public class SectionBinder2SectionPageLast
{
    public static PageSection PageSection { get; } = JsonLoader.CreatePageFromJson("""
{
	...
	"Sections": [
		...
		{"Type": "FooterSection", "Name": "Footer1", "Height": 70, "ViewMode": "PageLast", "Elements": [
			{"Type": "BindElement", "Bind": "Key1",   "Size": 10, "X": 10,  "Y": 0},
			{"Type": "SummaryElement", "Bind": "Foo", "Size": 10, "X": 100, "Y": 0, "Format": "P-Sum=#,0", "SummaryType": "Summary", "Alignment": "End", "Width": 50, "SummaryMethod": "Page"},
			{"Type": "SummaryElement", "Bind": "Foo", "Size": 10, "X": 110, "Y": 0, "Format": "P-Cnt=#,0", "SummaryType": "Count",   "Alignment": "End", "Width": 50, "SummaryMethod": "Page"},
			{"Type": "SummaryElement", "Bind": "Foo", "Size": 10, "X": 120, "Y": 0, "Format": "P-Avg=#,0", "SummaryType": "Average", "Alignment": "End", "Width": 50, "SummaryMethod": "Page"},
...
""", new());
    ...
    public void Line1_2()
    {
        var i = 0;
        var datas = MakeSectionData(100, 1, 1).ToList();
        datas.AddRange(MakeSectionData(200, 1, 2));
        var models = CreatePageModel(datas);
        Assert.Equal(models.Length, 1);
        ...
        Assert.Equal(ToSectionString(models[0].Models[i++]), "Detail/1");
        Assert.Equal(ToSectionString(models[0].Models[i++]), "Detail/2");
        Assert.Equal(ToSectionString(models[0].Models[i++]), "Footer1/200/P-Sum=3/P-Cnt=2/P-Avg=1/P-Max=2/P-Min=1/G-Sum=3/G-Cnt=2/G-Avg=1/G-Max=2/G-Min=1");
        Assert.Equal(ToSectionString(models[0].Models[i++]), "PageFooter/PageFooter/P-Sum=3/P-Cnt=2/P-Avg=1/P-Max=2/P-Min=1/A-Sum=4/A-Cnt=3/A-Avg=1/A-Max=2/A-Min=1/1///1");
    }
    ...
    public void Line1_3()
    {
        var i = 0;
        var datas = MakeSectionData(100, 1, 1).ToList();
        datas.AddRange(MakeSectionData(200, 1, 3));
        var models = CreatePageModel(datas);
        Assert.Equal(models.Length, 1);
        ...
        Assert.Equal(ToSectionString(models[0].Models[i++]), "Footer1/200/P-Sum=6/P-Cnt=3/P-Avg=2/P-Max=3/P-Min=1/G-Sum=6/G-Cnt=3/G-Avg=2/G-Max=3/G-Min=1");
        Assert.Equal(ToSectionString(models[0].Models[i++]), "PageFooter/PageFooter/P-Sum=6/P-Cnt=3/P-Avg=2/P-Max=3/P-Min=1/A-Sum=7/A-Cnt=4/A-Avg=1/A-Max=3/A-Min=1/1///1");
    }
    ...
    public void Line1_6()
    {
        ...
        Assert.Equal(ToSectionString(models[0].Models[i++]), "Footer1/200/P-Sum=21/P-Cnt=6/P-Avg=3/P-Max=6/P-Min=1/G-Sum=21/G-Cnt=6/G-Avg=3/G-Max=6/G-Min=1");
        Assert.Equal(ToSectionString(models[0].Models[i++]), "PageFooter/PageFooter/P-Sum=21/P-Cnt=6/P-Avg=3/P-Max=6/P-Min=1/A-Sum=22/A-Cnt=7/A-Avg=3/A-Max=6/A-Min=1/1///1");
    }
    ...
    public void Line1_7()
    {
        var i = 0;
        var datas = MakeSectionData(100, 1, 1).ToList();
        datas.AddRange(MakeSectionData(200, 1, 7));
        var models = CreatePageModel(datas);
        ...
        Assert.Equal(ToSectionString(models[0].Models[i++]), "Detail/5");
        Assert.Equal(ToSectionString(models[0].Models[i++]), "Detail/6");
        Assert.Equal(ToSectionString(models[0].Models[i++]), "Footer1/200/P-Sum=21/P-Cnt=6/P-Avg=3/P-Max=6/P-Min=1/G-Sum=28/G-Cnt=7/G-Avg=4/G-Max=7/G-Min=1");
        ...
        Assert.Equal(ToSectionString(models[1].Models[i++]), "Footer1/200/P-Sum=7/P-Cnt=1/P-Avg=7/P-Max=7/P-Min=7/G-Sum=28/G-Cnt=7/G-Avg=4/G-Max=7/G-Min=1");
        Assert.Equal(ToSectionString(models[1].Models[i++]), "PageFooter/PageFooter/P-Sum=7/P-Cnt=1/P-Avg=7/P-Max=7/P-Min=7/A-Sum=29/A-Cnt=8/A-Avg=3/A-Max=7/A-Min=1/2///2");
    }
    ...
    public void Line6_1()
    {
        ...
        Assert.Equal(ToSectionString(models[0].Models[i++]), "Detail/1");
        Assert.Equal(ToSectionString(models[0].Models[i++]), "Footer1/200/P-Sum=1/P-Cnt=1/P-Avg=1/P-Max=1/P-Min=1/G-Sum=1/G-Cnt=1/G-Avg=1/G-Max=1/G-Min=1");
        Assert.Equal(ToSectionString(models[0].Models[i++]), "PageFooter/PageFooter/P-Sum=1/P-Cnt=1/P-Avg=1/P-Max=1/P-Min=1/A-Sum=22/A-Cnt=7/A-Avg=3/A-Max=6/A-Min=1/1///1");
    }
