                ...
                case LinearGradientLayer linear when linear.StopColors.Length > 0:
                    {
                        ...
                        {
                            var shading = AxialShading.Create($"sh{document.Resources.Shadings.Count}", linear, ColorToAlpha, "/DeviceGray").Return(document.Resources.Shadings.Add);
                            ...
                            gstream.Flush();
                            opes.Add(new DrawPathExtGState { ExtGState = GraphicsStateParameter.CreateTransparency($"gs{document.Resources.GraphicsStateParameters.Count}", g).Return(document.Resources.GraphicsStateParameters.Add) });
                        }
                        opes.Add(new DrawPathShading { Shading = AxialShading.Create($"sh{document.Resources.Shadings.Count}", linear, ColorToRGB, "/DeviceRGB").Return(document.Resources.Shadings.Add) });
                        break;
                    }
                ...
                case RadialGradientLayer radial when radial.StopColors.Length > 0:
                    {
                        ...
                        {
                            var shading = RadialShading.Create($"sh{document.Resources.Shadings.Count}", radial, ColorToAlpha, "/DeviceGray").Return(document.Resources.Shadings.Add);
                            // Set a sufficiently large enough for the BBox.
                        ...
                        opes.Add(new DrawPathShading { Shading = RadialShading.Create($"sh{document.Resources.Shadings.Count}", radial, ColorToRGB, "/DeviceRGB").Return(document.Resources.Shadings.Add) });
                        break;
                    }
