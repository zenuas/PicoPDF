...
public class StandardEncryption4 : PdfObject, IStandardEncryption
{
    ...
    public static StandardEncryption4 Create(CFM cfm, string user_password, string owner_password, UserAccessPermissions permissions, byte[] document_id, bool metadata_encrypted = true)
    {
