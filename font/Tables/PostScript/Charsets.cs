...
public class Charsets
{
    ...
    public static readonly Dictionary<int, string> ISOAdobe = new()
    {
        [1] = "space",
        [2] = "exclam",
        [3] = "quotedbl",
    ...
    public static readonly Dictionary<int, string> Expert = new()
    {
        [1] = "space",
        [229] = "exclamsmall",
    ...
    public static readonly Dictionary<int, string> ExpertSubset = new()
    {
        [1] = "space",
        [231] = "dollaroldstyle",
        [232] = "dollarsuperior",
