...
public class PaintVarScale : IPaintFormat, IHavePaint
{
    ...
    public static PaintVarScale ReadFrom(Stream stream, Dictionary<long, IPaintFormat> paintCache, Dictionary<long, IColorLine> colorLineCache, Dictionary<long, IAffine2x3> affineCache)
    {
