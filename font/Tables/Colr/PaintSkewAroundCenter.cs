...
public class PaintSkewAroundCenter : IPaintFormat, IHavePaint
{
    ...
    public static PaintSkewAroundCenter ReadFrom(Stream stream, Dictionary<long, IPaintFormat> paintCache)
    {
