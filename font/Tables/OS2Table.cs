...
public record class OS2Table : IExportable
{
    ...
    public static OS2Table Create() => new()
    {
        ...
        UsWidthClass = 5,
        FsType = 0,
        YSubscriptXSize = 1000,
        YSubscriptYSize = 1000,
        YSubscriptXOffset = 1000,
        YSubscriptYOffset = 1000,
        YSuperscriptXSize = 1000,
        YSuperscriptYSize = 1000,
        YSuperscriptXOffset = 0,
        YSuperscriptYOffset = 0,
        YStrikeoutSize = 100,
        YStrikeoutPosition = 100,
        SFamilyClass = 0,
