...
public class FooterSection : IFooterSection, ISectionStyle
{
    ...
    public ViewModes ViewMode { get; init => field = value is ViewModes.Last or Binder.Data.ViewModes.PageLast or ViewModes.Every ? value : throw new ArgumentException(); } = ViewModes.Last;
