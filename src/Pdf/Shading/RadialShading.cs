...
public class RadialShading : PdfObject, IShading
{
    ...
    public override void DoExport(PdfExportOption option)
    {
        ...
        _ = Elements.TryAdd("Coords", $"[{PdfUtility.PointToString(Coords.X0.ToPoint(), option.PointFormat)} {PdfUtility.PointToString(Coords.Y0.ToPoint(), option.PointFormat)} {PdfUtility.PointToString(Coords.R0.ToPoint(), option.PointFormat)} {PdfUtility.PointToString(Coords.X1.ToPoint(), option.PointFormat)} {PdfUtility.PointToString(Coords.Y1.ToPoint(), option.PointFormat)} {PdfUtility.PointToString(Coords.R1.ToPoint(), option.PointFormat)}]");
