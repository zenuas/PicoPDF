...
public static class PdfUtility
{
    ...
    public static Document CreateDocument<T>(string json, IEnumerable<T> datas, Dictionary<string, Func<T, object>>? mapper = null, IFontRegister? register = null, PdfEventOption? option = null) => CreateDocument(JsonLoader.Load(json, option), datas, mapper, register);
    public static Document CreateDocument(string json, DataTable table, IFontRegister? register = null, PdfEventOption? option = null) => CreateDocument(JsonLoader.Load(json, option), table, register);
    public static Document CreateDocument(string json, DataView view, IFontRegister? register = null, PdfEventOption? option = null) => CreateDocument(JsonLoader.Load(json, option), view, register);
