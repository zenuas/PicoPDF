...
public static class PdfUtility
{
    ...
    public static Document CreateDocument<T>(string json, IEnumerable<T> datas, Dictionary<string, Func<T, object>>? mapper = null, IFontRegister? register = null, PdfEventOption? option = null) => CreateDocument(JsonLoader.CreatePageFromJsonFile(json, option), datas, mapper, register);
    public static Document CreateDocument(string json, DataTable table, IFontRegister? register = null, PdfEventOption? option = null) => CreateDocument(JsonLoader.CreatePageFromJsonFile(json, option), table, register);
    public static Document CreateDocument(string json, DataView view, IFontRegister? register = null, PdfEventOption? option = null) => CreateDocument(JsonLoader.CreatePageFromJsonFile(json, option), view, register);
    public static Document CreateDocument<T>(PageSection pagesection, IEnumerable<T> datas, Dictionary<string, Func<T, object>>? mapper = null, IFontRegister? register = null) => new Document { FontRegister = register ?? CreateDefaultFontRegister() }.Return(x => ModelMapping.Mapping(x, SectionBinder.Bind<T, PageModel, SectionModel>(pagesection, datas, mapper)));
    public static Document CreateDocument(PageSection pagesection, DataTable table, IFontRegister? register = null) => new Document { FontRegister = register ?? CreateDefaultFontRegister() }.Return(x => ModelMapping.Mapping(x, SectionBinder.Bind<PageModel, SectionModel>(pagesection, table)));
    public static Document CreateDocument(PageSection pagesection, DataView view, IFontRegister? register = null) => new Document { FontRegister = register ?? CreateDefaultFontRegister() }.Return(x => ModelMapping.Mapping(x, SectionBinder.Bind<PageModel, SectionModel>(pagesection, view)));
